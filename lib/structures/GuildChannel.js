...
class GuildChannel extends Channel {
    ...
    * @arg {String} [reason] The reason to be displayed in audit logs
    * @returns {Promise<CategoryChannel | GroupChannel | TextChannel | TextVoiceChannel | NewsChannel | NewsThreadChannel | ForumChannel | PrivateThreadChannel | PublicThreadChannel>}
    */
    edit(options, reason) {
